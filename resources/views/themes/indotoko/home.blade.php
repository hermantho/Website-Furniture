    ...
    <div class="row mt-5">
      <div class="col-lg-3 col-6">
        <div class="card card-body p-lg-4 p3">
          ...
          <h3 class="product-name mt-3">Sofa All Set</h3>
          <div class="rating">
      ...
      <div class="col-lg-3 col-6">
        <div class="card card-body p-lg-4 p3">
          ...
          <h3 class="product-name mt-3">Side Chair</h3>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
      ...
      <div class="col-lg-3 col-6 mt-3 mt-lg-0">
        <div class="card card-body p-lg-4 p3">
          ...
          <h3 class="product-name mt-3">Lounge Chair</h3>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
      ...
      <div class="col-lg-3 col-6 mt-3 mt-lg-0">
        <div class="card card-body p-lg-4 p3">
          ...
          <h3 class="product-name mt-3">Sofa Bed</h3>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
