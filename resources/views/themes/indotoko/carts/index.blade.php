                            ...
                            <li class="list-group-item py-3 border-top">
                                <div class="row align-items-center">
                                    <div class="col-6 col-md-6 col-lg-7">
                                        <div class="d-flex">
                                            @if ($item->product->name == 'MACY SIDE CHAIR BLACK')
                                                <img src="{{ asset('img/macy.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @elseif ($item->product->name == 'CIELO SIDE CHAIR')
                                                <img src="{{ asset('img/cielo.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @elseif ($item->product->name == 'CORDA ARMCHAIR')
                                                <img src="{{ asset('img/corda.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @elseif ($item->product->name == 'ARM CHAIR')
                                                <img src="{{ asset('img/aruna.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @elseif ($item->product->name == 'SCRIBBLE STUDY HIGH CHAIR')
                                                <img src="{{ asset('img/study.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @elseif ($item->product->name == 'SAHARA SIDE TABLE')
                                                <img src="{{ asset('img/sahara.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @else
                                                <img src="{{ asset('img/default.jpg') }}" alt="{{ $item->product->name }}" style="height: 70px;">
                                            @endif
                                            <div class="ms-3">
