            ...
            <div class="col-md-6">
                <div class="product-detail mt-6 mt-md-0">
                    ...
                    <div class="mb-3 rating">
                        ...
                        <a href="#" class="ms-2">(50 reviews)</a>
                    </div>
                    <div class="price">
            ...
            <div class="product-description pt-5">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-product-details-tab" data-bs-toggle="tab" data-bs-target="#nav-product-details" type="button" role="tab" aria-controls="nav-product-details" aria-selected="true">Description</button>
